...
def get_small_bert(num_classes, depth=10):
    return BertForClassification(depth=depth, heads=8, dim_head=64, num_classes=num_classes, vocab_size=30522)


def get_base_bert(num_classes, depth=12):
    return BertForClassification(depth=depth, heads=12, dim_head=64, num_classes=num_classes, vocab_size=30522)
