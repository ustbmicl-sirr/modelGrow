...
def get_ada_growing_vit_patch2_32(depth=2, heads=6, num_classes=10, image_channels=3):
...
def get_ada_growing_vit_patch4_64(depth=2, heads=6, num_classes=10, image_channels=3):
...
def get_ada_growing_vit_patch16_224(depth=2, heads=6, num_classes=10, image_channels=3):
