...
class PlainBlock(nn.Module):
    def __init__(self, in_planes, planes, stride=1, kernel_size=(3, 3)):
        ...
        self.feature = nn.Conv2d(in_planes, planes, kernel_size, stride=stride, padding=1)
...
def get_runtime_vgg(depths, num_classes=10, image_channels=3):
    if len(depths) == 3:
